...
export default function About() {
  return (
    <div className="page-wrap py-16 max-w-3xl mx-auto">
      <h1 className="font-display text-3xl mb-8" style={{ color: "#2C3E2D" }}>About SPEKD</h1>
      <div className="space-y-6 text-sm leading-relaxed" style={{ color: "#6B6560" }}>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>Our Mission</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>For the Trade</h2>
        <p>
