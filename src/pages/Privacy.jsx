export default function Privacy() {
  return (
    <div className="page-wrap py-16 max-w-3xl mx-auto">
      <h1 className="font-display text-3xl mb-8" style={{ color: "#2C3E2D" }}>Privacy Policy</h1>
      <div className="space-y-6 text-sm leading-relaxed" style={{ color: "#6B6560" }}>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>1. Information We Collect</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>2. How We Use Your Information</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>3. Data Storage and Security</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>4. Cookies and Tracking</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>5. Third-Party Services</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>6. Your Rights</h2>
        <p>
        ...
        <h2 className="font-display text-xl pt-4" style={{ color: "#2C3E2D" }}>7. Contact</h2>
        <p>
