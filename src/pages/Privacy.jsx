  ...
  return (
    <div className="page-wrap py-16 max-w-3xl mx-auto">
      ...
      <div className="space-y-6 text-sm text-white/60 leading-relaxed">
        <p className="text-white/40 text-xs">Last updated: March 19, 2026</p>

        <h2 className="font-display text-xl text-white pt-4">1. Information We Collect</h2>
        <p>
        ...
        <h2 className="font-display text-xl text-white pt-4">2. How We Use Your Information</h2>
        <p>
        ...
        <h2 className="font-display text-xl text-white pt-4">3. Data Storage and Security</h2>
        <p>
        ...
        <h2 className="font-display text-xl text-white pt-4">4. Cookies and Tracking</h2>
        <p>
        ...
        <h2 className="font-display text-xl text-white pt-4">5. Third-Party Services</h2>
        <p>
        ...
        <h2 className="font-display text-xl text-white pt-4">6. Your Rights</h2>
        <p>
        ...
        <h2 className="font-display text-xl text-white pt-4">7. Contact</h2>
        <p>
          For questions about this privacy policy, contact us at{" "}
          <a href="mailto:support@spekd.ai" className="text-gold/70 hover:text-gold transition-colors">
            support@spekd.ai
          </a>.
        </p>
      </div>
