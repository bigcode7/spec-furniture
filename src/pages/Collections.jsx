      ...
      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-200 flex flex-col justify-end p-3">
        ...
        <div className="flex items-center gap-1 mt-2" onClick={(e) => e.stopPropagation()}>
          <button
            ...
            className={`p-1.5 rounded-lg transition-colors ${isCompared ? "bg-gold/80 text-black" : "bg-white/10 text-white/70 hover:bg-white/20"}`}
            title="Compare"
          >
      ...
      <div className="min-h-screen bg-[#08090E] text-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <motion.div
            ...
            className="mb-8"
          >
            <h1 className="text-3xl font-bold font-display tracking-tight mb-1">{collectionParam}</h1>
            ...
            <>
              ...
              >
                <div className="rounded-xl glass-surface p-3">
                  <p className="text-[10px] text-white/30 uppercase tracking-wider label-caps">Products</p>
                  <p className="text-lg font-semibold text-white mt-0.5">{detailProducts.length}</p>
                </div>
                <div className="rounded-xl glass-surface p-3">
                  <p className="text-[10px] text-white/30 uppercase tracking-wider label-caps">Categories</p>
                  <p className="text-sm font-medium text-white mt-1 line-clamp-1">{detailCategories.slice(0, 3).join(", ") || "--"}</p>
                </div>
                <div className="rounded-xl glass-surface p-3">
                  <p className="text-[10px] text-white/30 uppercase tracking-wider label-caps">Price Range</p>
                ...
                <div className="rounded-xl glass-surface p-3">
                  <p className="text-[10px] text-white/30 uppercase tracking-wider label-caps">Materials</p>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold font-display tracking-tight">Collections</h1>
          </div>
        ...
        >
          ...
          <div className="relative flex-1 w-full sm:max-w-sm">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2 rounded-xl bg-white/[0.04] border border-white/[0.06] text-sm text-white placeholder-white/30 focus:outline-none focus:border-gold/30 focus:ring-1 focus:ring-gold/20 transition-all"
            />
            {searchFilter && (
              <button
          ...
          <div className="relative">
            ...
            <select
              ...
              className="appearance-none pl-10 pr-8 py-2 rounded-xl bg-white/[0.04] border border-white/[0.06] text-sm text-white focus:outline-none focus:border-gold/30 focus:ring-1 focus:ring-gold/20 transition-all cursor-pointer"
            >
                  ...
                  <CollectionCard
                    ...
                    onClick={() => {
                      setSearchParams({
                        ...
                        vendor: collection.vendor_id || collection.vendor_name || "",
                      });
                    }}
                  />
                ))}
