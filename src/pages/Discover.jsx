      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold font-display tracking-tight">Discover</h1>
          </div>
        ...
        <AnimatePresence mode="wait">
          {mode === "mood" ? (
            ...
            >
              {/* ROW 1: COLOR PALETTE */}
              <div className="mb-8">
                <h3 className="text-sm font-medium text-white/40 uppercase tracking-wider label-caps mb-3 flex items-center gap-2">
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-xl p-3 border transition-all duration-200 text-left ${
                          selected
                            ? "border-gold/50 ring-2 ring-gold/30 bg-gold/[0.08] scale-[1.02]"
                    ...
                    return (
                      <button
                        ...
                        className={`rounded-xl p-4 border transition-all duration-200 text-left ${
                          selected
                            ? "border-gold/50 ring-2 ring-gold/30 scale-[1.02]"
