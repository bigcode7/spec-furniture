...
export default function PresentationGenerator({ products }) {
        ...
        >
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            {presentation.style_direction && (
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] p-6">
                <div className="flex items-center gap-2 text-xs font-semibold uppercase tracking-[0.18em] text-gold/70 mb-3">
