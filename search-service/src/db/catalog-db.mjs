...
async function downloadCatalogIfMissing() {
  ...
  if (fs.existsSync(DB_PATH)) {
    ...
    const CATALOG_VERSION = "v4-sherrill-tagged";
    if (size > 50_000_000) {
      try {
  ...
  const urls = [
    "https://github.com/bigcode7/spec-furniture/releases/download/catalog-v4-sherrill-tagged/catalog-full-v4.json.gz",
  ];
  ...
  try {
    ...
    ws.write('{"version":1,"catalog_version":"v4-sherrill-tagged","saved_at":"' + new Date().toISOString() + '","products":[');
